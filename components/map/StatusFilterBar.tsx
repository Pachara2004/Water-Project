...
export default function StatusFilterBar({ value, onChange }: StatusFilterBarProps) {
    ...
    return (
        ...
        <button
            ...
            className="bg-surface flex items-center gap-3 px-4 py-3 rounded-xl text-sm transition-all duration-300 shadow-sm hover:shadow-md active:scale-[0.97] cursor-pointer max-w-40 sm:max-w-xs"
        >
