    ...
    return (
        <div className="relative" ref={anchorRef}>
            <button
                ...
                className="w-full flex items-center justify-between gap-2 px-4 py-3 bg-surface-subtle border border-border text-text-primary rounded-xl text-xs min-h-11 font-semibold transition-all cursor-pointer select-none disabled:opacity-50 disabled:cursor-not-allowed"
            >
