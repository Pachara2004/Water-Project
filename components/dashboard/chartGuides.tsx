...
export const CHART_GUIDES: Record<GuideKey, { title: string; blocks: GuideBlock[] }> = {
    ...
    hotspots: {
        ...
        blocks: [
            ...
            {
                heading: "อ่านยังไง",
                items: ['ช่อง "อัตรา" คือเจออันตรายคิดเป็นกี่เปอร์เซ็นต์ของการตรวจทั้งหมดที่สถานีนั้น', 'ช่อง "ครั้ง" คือเจออันตรายกี่ครั้ง จากที่ตรวจไปทั้งหมดกี่ครั้ง'],
            },
            {
                heading: "ระวัง",
    ...
    temporal: {
        ...
        blocks: [
            ...
            {
                heading: "อ่านยังไง",
                items: ["แท่งสีฟ้าคือตัวอย่างที่เก็บก่อนเที่ยง (00:00–11:59)", "แท่งสีเหลืองคือตัวอย่างที่เก็บหลังเที่ยง (12:00–23:59)", "แท่งยิ่งสูง แปลว่าค่าเฉลี่ยของสารตัวนั้นยิ่งสูง"],
            },
        ],
    },
    trend: {
