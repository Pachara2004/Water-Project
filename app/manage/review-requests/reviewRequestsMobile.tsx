/**
 * @file reviewRequestsMobile.tsx
 * @project Water Monitoring Project
 * @module App / Manage / Review Requests
 * @description
 * view มือถือของหน้าตรวจสอบคำร้อง: PageHeader, StatusTabs, ตัวกรองสถานะน้ำ/ช่วงวันที่, รายการ
 * RequestCardMobile, PaginationBar และ drawer/lightbox จาก reviewRequestsHelpers
 * ประกาศ ReviewRequestsPageProps ที่ reviewRequestsDesktop ใช้ร่วมด้วย
 *
 * Mobile review-queue view; also declares the shared ReviewRequestsPageProps.
 *
...
/** Props ร่วมของ ReviewRequestsMobile / ReviewRequestsDesktop ทั้งหมดมาจาก page.tsx */
...
/**
 * หน้าตรวจสอบคำร้องบนมือถือ
 *
 * @param props - ดู {@link ReviewRequestsPageProps}
 */
