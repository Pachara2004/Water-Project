/**
 * @file historyDesktop.tsx
 * @project Water Monitoring Project
 * @module App / Collector / History
 * @description
 * view desktop ของหน้ารายละเอียดตัวอย่างน้ำ แบ่ง 2 คอลัมน์: ซ้าย = สรุป/ข้อมูลประกอบ (แก้ไขได้), ขวา = ภาพและผลวิเคราะห์
 ...
 *
 * Desktop view of the sample-session detail page; reuses submit-flow components read-only. Layout only.
 *
...
/**
 * หน้ารายละเอียดตัวอย่างบน desktop
 *
                ...
                {isEditing ? (
                    <div ref={locationDropdownRef} className="relative mt-2">
                        <input
                            ...
                            className={`w-full text-xs bg-surface-subtle border rounded-lg px-3 py-2.5 outline-hidden ${locationSearch && !isLocationValid ? "border-red-400" : "border-border"}`}
                        />
