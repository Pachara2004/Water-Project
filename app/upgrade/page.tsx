...
import { KeyRound, ShieldAlert, Lock, ShieldCheck, Sparkles } from "lucide-react";
...
export default function UpgradePage() {
    ...
    */
        <div
            className="min-h-dvh bg-surface-muted pb-10
            ...
            <div className="w-full max-w-md sm:max-w-lg">
                ...
                <div className="bg-surface rounded-3xl p-8 sm:p-10 lg:p-12 border border-border shadow-sm space-y-8 relative overflow-hidden transition-all duration-200">
                    <div className="flex flex-col items-center text-center">
                        ...
                        <h1 className="text-2xl sm:text-3xl font-bold text-text-primary tracking-wide leading-tight mb-3">ยืนยันสิทธิ์การเข้าใช้งาน</h1>
                        <p className="text-sm sm:text-base text-text-secondary max-w-[85%] leading-loose">โปรดกรอกรหัสยืนยันสิทธิ์ (Passcode) เพื่อทำการเปิดขอบข่ายหน้าที่ตามการปฏิบัติงานของคุณ</p>
                    </div>

                    <form onSubmit={handleUpgrade} className="space-y-5">
                        <div className="space-y-3">
                            <label className="text-xs sm:text-sm font-bold text-text-muted uppercase tracking-wider block font-mono">Access Passcode</label>
