...
function SubmitContent() {
    ...
    const handleImageSelect = async (paramId: number, file: File) => {
        ...
        // ต้องอ่านพิกัดจากไฟล์ต้นฉบับให้เสร็จก่อนส่งไฟล์ไปประมวลผล
        // เพื่อไม่ให้ mobile WebView อ่าน stream ของไฟล์พร้อมกันหลายส่วน
        await hook.processImageExif(file);
