/**
 * @file app/submit/loading.tsx
 * @project Water Monitoring Project
 * @module App / Submit / Loading
 * @description
 * Skeleton ของหน้าส่งตรวจ: แถบหัว, ขั้นตอน และการ์ดฟอร์ม
 *
 * Route loading UI for /submit.
 *
    ...
    return (
        <div className="min-h-dvh w-full bg-bg pb-5 antialiased animate-pulse">
            ...
            <div className="bg-surface border-b border-border px-4 py-1 flex items-center justify-between sticky top-0 z-10 h-11">
                <div className="flex items-center gap-1.5 text-sm text-text opacity-50 font-semibold">
