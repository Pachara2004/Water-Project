                        ...
                        <div className={`space-y-4 transition-opacity duration-200 ${!analytics ? "opacity-40 pointer-events-none" : "opacity-100"}`}>
                            ...
                            <div className="grid grid-cols-12 gap-2.5 shrink-0">
                                {analytics?.kpis?.map((kpi: any, index: number) => (
                                    <div
                                        key={index}
                                        className={`bg-card-general rounded-xl border border-border p-3 flex flex-col border-l-10 ${kpiSpanClass(kpi.w)}`}
                            ...
                            <div className="grid grid-cols-12 gap-3">
                                ...
                                {!analytics?.stationDetail && (
                                    <div className="col-span-5 bg-surface rounded-xl border border-border p-4 flex flex-col overflow-visible justify-between">
                                ...
                                <div className={`bg-card-general rounded-xl border border-border p-3 flex flex-col gap-3 overflow-visible ${analytics?.stationDetail ? "col-span-12" : "col-span-7"}`}>
