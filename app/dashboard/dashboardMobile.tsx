                            ...
                            <div className="flex items-center pt-2 justify-between shrink-0">
                                ...
                                {analytics?.kpis?.some((k: any) => k.trend && getTrendPolarity(k.title) !== "neutral") && (
                                    <button
                                        ...
                                        className="h-8 inline-flex items-center gap-1.5 px-2.5 rounded-lg bg-card-general border border-border text-xs font-semibold text-text-secondary hover:text-text-primary hover:border-text-muted transition-colors cursor-pointer shrink-0"
